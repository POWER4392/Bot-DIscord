...
- **Tương thích:** SQLite (local) và PostgreSQL (cloud/Koyeb)
...
| PostgreSQL | 14+ | Lưu trữ cloud (Koyeb) |
...
| 12 | Cloud deployment (Koyeb) | ✅ Hoàn thành |
...
- **DevOps**: Cloud deployment trên Koyeb, CI/CD qua GitHub
...
- Tích hợp Large Language Model (GPT/Gemini) cho chatbot AI thực sự
- Dashboard web thay thế GUI desktop
- Hệ thống phân tích sentiment tin nhắn
- Machine Learning cho phát hiện spam chính xác hơn
