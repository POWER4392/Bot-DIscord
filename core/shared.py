...
YDL_OPTIONS = {'format': 'bestaudio/best', 'noplaylist': 'False', 'quiet': True, 'no_warnings': True, 'default_search': 'ytsearch', 'extractor_args': {'youtube': ['player_client=android_vr']}}
