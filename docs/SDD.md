...
**► [CHÈN HÌNH ẢNH: flowchart_ticket.png VÀO ĐÂY]**
...
**► [CHÈN HÌNH ẢNH: flowchart_voice.png VÀO ĐÂY]**
...
**► [CHÈN HÌNH ẢNH: flowchart_leveling.png VÀO ĐÂY]**
...
**► [CHÈN HÌNH ẢNH: flowchart_social.png VÀO ĐÂY]**
...
**► [CHÈN HÌNH ẢNH: flowchart_dashboard.png VÀO ĐÂY]**
...
**► [CHÈN HÌNH ẢNH: architecture_diagram.png VÀO ĐÂY]**
...
classDiagram
    ...
    class AIChatbot {
        ...
        -_get_session(guild_id, user_id, prompt) : ChatSession

        -_save_message_to_db(guild_id, user_id, role, content) : None

        -_load_history_from_db(guild_id, user_id) : list

        -_clear_history_in_db(guild_id, user_id) : None

        -_retrieve_relevant_rules(query) : str

        -_save_token_usage_to_db(guild_id, user_id, prompt_tokens, completion_tokens, total_tokens) : None

        +on_message(message) : None

        +ask(interaction, question, image) : None
    ...
    class MusicControlView {
        ...
        +pause_resume(interaction, button) : None

        +skip(interaction, button) : None

        +stop(interaction, button) : None

        +shuffle(interaction, button) : None

        +queue_btn(interaction, button) : None

        +autoplay_toggle(interaction, button) : None
    ...
    class Moderation {
        ...
        +mute(ctx, member, time, reason) : None
    ...
    class Social {
        ...
        +add_social(ctx, platform, target, channel, ping_role) : None

        +rm_social(ctx, platform, target_id) : None

        +list_social(ctx) : None

    }

    class DoiLinkView {

        +__init__(platform, link)
    ...
    class DatabaseProxy {
        ...
        +db_update_xp(guild_id, user_id, xp_add) : tuple
    ...
    Utilities ..> QuizView : uses

    Utilities ..> QuizAnswerButton : uses
...
**► [CHÈN HÌNH ẢNH: sequence_diagram_chat.png VÀO ĐÂY]**
